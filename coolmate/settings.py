"""
Django settings for coloshop project.
...
SECRET_KEY = 'django-insecure-(q___bk303do^^z8ar^$at+)z8cwihrxi@h%x$uhtumiogz@4d'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                ...
                os.path.join(BASE_DIR, 'Promotion/templates'),
...
WSGI_APPLICATION = 'coolmate.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'Promotion/static'),
